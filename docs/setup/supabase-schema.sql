-- Run this entire block in Supabase SQL Editor before starting Month 2
...
-- Vector search function used by RagAgent
...
RETURNS TABLE (
    id UUID, content TEXT, summary TEXT,
    source TEXT, metadata JSONB, similarity FLOAT
)
LANGUAGE plpgsql AS $$
BEGIN
    RETURN QUERY
    SELECT am.id, am.content, am.summary, am.source, am.metadata,
